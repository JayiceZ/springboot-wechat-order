...
import com.jay.wechat.utils.EnumUtil;
...
public class OrderMaster {
    ...
    public OrderStatusEnum getOrderStatusEnum(){
        return EnumUtil.getByCode(order_status,OrderStatusEnum.class);
    }

    @JsonIgnore
    public PayStatusEnum getPayStatusEnum(){
        return EnumUtil.getByCode(pay_status,PayStatusEnum.class);
    }
